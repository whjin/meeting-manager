...
function openDev () {
  ...
  var jsonObj = {
    FuncName: 'camOpenDev',
    argument: { devIndex: 0, subtype: 0, width: 0, height: 0 }
  };
  sendWsMessage(jsonObj);
  // 开始预览
...
function DevSetting () {
  ...
  var jsonObj = {
    ...
    argument: { devIndex: objSelect.selectedIndex }
  };
  sendWsMessage(jsonObj);
}
// 关闭设备
...
function configureRestionInfo (names) {
  ...
  objSelect.onchange = function () {
    var jsonObj = {
      ...
      argument: { index: objSelect.selectedIndex }
    };
    sendWsMessage(jsonObj);
  };
}
...
function SetRotationStyle () {
  ...
  var jsonObj = {
    ...
    argument: { rotateMode: objSelect.selectedIndex }
  };
  sendWsMessage(jsonObj);
}
// 自动裁切
function SetCutStyle () {
  ...
  var jsonObj = {
    ...
    argument: { CropType: objSelect.selectedIndex }
  };
  sendWsMessage(jsonObj);
...
function setImageAdjust () {
  ...
  var jsonObj = {
    ...
    argument: { Type: objectSelect.selectedIndex }
  };
  sendWsMessage(jsonObj);
}
// 判断文件存在
...
function DPISet () {
  ...
  var jsonObj = {
    ...
    argument: { xDPI: parseInt(xdpi), yDPI: parseInt(ydpi) }
  };
  sendWsMessage(jsonObj);
}
// 设置JPG压缩率
function JPGQSet () {
  ...
  var jsonObj = {
    ...
    argument: { quanlity: parseInt(JPGQ) }
  };
  sendWsMessage(jsonObj);
}
...
function continuCapture () {
  ...
  var jsonObj = {
    ...
    argument: { type: 0, param: 4, filePath: filepath }
  };
  AutoCaptureTime = 4;
  sendWsMessage(jsonObj);
}
...
function timeCapture () {
  ...
  var jsonObj = {
    FuncName: 'camStartAutoCapture',
    argument: { type: 1, param: 4, filePath: filepath }
  };
  AutoCaptureTime = 4;
  sendWsMessage(jsonObj);
}
...
function compareVideo () {
  ...
  var jsonObj = {
    ...
    argument: { filePath: url1, videoFilePath: '', ldelayTime: 0 }
  };
  sendWsMessage(jsonObj);
}
...
function comparePic () {
  ...
  var jsonObj = {
    ...
    argument: { filePath1: url1, filePath2: url2 }
  };
  sendWsMessage(jsonObj);
}
...
function CombinePDF (path, JQ) {
  ...
  var jsonObj = {
    ...
    argument: { filePath: filepath, JpegQuality: JpegQuaility }
  };
  sendWsMessage(jsonObj);
}
...
function coderRecBarcode () {
  ...
  var jsonObj = {
    ...
    argument: { strBarcodePath: BarcodePath }
  };
