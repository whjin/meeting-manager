...
var returnTime = new Date().getTime();// mouseup返回时间
...
function get_cursor_x_position (e) {
  ...
  if (e.pageX || e.pageY) {
    ...
    posx = (e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft) - posx;
  }
