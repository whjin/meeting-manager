<template>
  <div class="cascaderNew" :class="{'modifyStyle':modify2}">
    <cascader v-model="newValue"
              :data="data"
              :load-data="loadData"
              :render-format="format"
              not-found-text="异常：无法获取数据，请稍后再试"
              :placeholder="modify2 ? modify2 : '请选择'"
              change-on-select
              filterable
              :searchLastValueParent="searchLastValueParent"
...
<style lang="less">
  ...
  .cascaderNew{
    ...
    .ivu-select-dropdown{
      ...
      .ivu-cascader-menu-item,.ivu-select-item{
