  ...
  <i-layout class="main-content-con">
        ...
        <i-layout class="main-layout-con">
          <i-content class="content-wrapper">
            <div class="searchTitleInput" style="height: 60px">
              ...
              <input class="searchItemInput" v-model="searchCon.lawyerName" placeholder="请输入律师姓名">
    ...
    <i-modal width="700" v-model="isOpenDetail" @on-ok="isOpenDetail = false">
      ...
      <div class="objInfoModal" style="height:350px;">
        ...
        <i-tooltip :content="meetingNotes.lawyerId" placement="top-start" v-show="meetingNotes.lawyerId">
          律师身份证号：{{meetingNotes.lawyerId}}
        </i-tooltip>
        <div class="unToolTip" v-show="!meetingNotes.lawyerId">
          律师身份证号：{{meetingNotes.lawyerId}}
        </div>
        <i-tooltip :content="meetingNotes.lawyerName" placement="top-start" v-show="meetingNotes.lawyerName">
          律师姓名：{{meetingNotes.lawyerName}}
        </i-tooltip>
        <div class="unToolTip" v-show="!meetingNotes.lawyerName">
          律师姓名：{{meetingNotes.lawyerName}}
        </div>
