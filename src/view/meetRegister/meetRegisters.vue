        ...
        <i-tabs style="height: calc(100% - 100px);" @on-click="changeTabs">
          <i-tab-pane label="会见审核" name="manage" style="position:relative;">
            <div class="searchTitleInput">
              ...
              <span class="searchItemText">身份证号:</span>
              <input class="searchItemInput" type="text" v-model="searchCon.data.prisonerIdCard" placeholder="请输入在押人员身份证号">
              ...
              <span class="searchItemText">律师身份证号:</span>
              <input class="searchItemInput" type="text" v-model="searchCon.data.idCard" placeholder="请输入律师身份证号">
              <span class="searchItemText">预约时间:</span>
              <i-date-picker class="searchItemDate" type="date" @on-change="setGrantDateStart" format="yyyy-MM-dd" placeholder="请选择日期"></i-date-picker>
              <span class="searchItemText" style="text-align: center; text-indent: 12px;">至</span>
              <i-date-picker class="searchItemDate" type="date" @on-change="setGrantDateEnd" format="yyyy-MM-dd" placeholder="请选择日期"></i-date-picker>
              <i-button ghost @click="searchByCon" class="searchButton" style="margin-left: 25px;">查询</i-button>
            </div>
            ...
            <i-modal v-model="auditModal" width="1300px" @on-visible-change="closeModal">
              <p slot="header">
                <span class="title">{{isAudit?'会见审核':'资料详情'}}</span>
              </p>
              <div class="auditInfo" style="height: 600px;overflow: auto">
                <i-form ref="auditModel" :model="auditModel" :label-width="155" label-position="right">
                  <div style="width: 100%;">
                    <div style="width: calc(100% - 170px);display: inline-block;">
                      ...
                      <i-row style="margin-top: 10px">
                        <i-form-item label="姓名:" prop="prisonerName">
                          <i-input v-model="auditModel.prisonerName" disabled></i-input>
                        </i-form-item>
                        <i-form-item label="身份证号码:" prop="prisonerIdCard">
                          <i-input v-model="auditModel.prisonerIdCard" disabled></i-input>
                        </i-form-item>
                  ...
                  <i-row>
                    ...
                    <i-col span="8">
                      <i-form-item label="执业机构:" prop="lawyerUnit">
                  ...
                  <i-row>
                    <i-col span="8">
                      <i-form-item label="预约会见日期:" prop="appointmentDate">
                        <i-input v-model="auditModel.appointmentDate" disabled></i-input>
                      </i-form-item>
                    </i-col>
                    <i-col span="8">
                      <i-form-item label="会见时间段:" prop="appointmentTime">
                  ...
                  <i-row>
                    <i-col span="8">
                      <i-form-item label="律师会见房间:" prop="lawyerRoomName">
                        <i-input v-model="auditModel.lawyerRoomName" disabled></i-input>
                      </i-form-item>
                    </i-col>
                    <i-col span="8">
                      <i-form-item label="在押人员会见房间:" prop="meetingRoomName">
                        <i-input v-model="auditModel.meetingRoomName" disabled></i-input>
                      </i-form-item>
                    </i-col>
                    <i-col span="8"></i-col>
                  </i-row>
                  <i-row style="margin-top: 10px">
                    <div style="font-size: 20px;color: #35FFFA;">律师资料照片</div>
                      ...
                      <i-row>
                        <i-col span="4">
                          ...
                          <a class="upload-content">
                            ...
                            <i-button class="searchButton" type="primary" :size="small" style="display: inline-block;" @click="download(auditModel.idCardUrl)">查看</i-button>
                          </a>
                        </i-col>
                        <i-col span="4">
                          <span>现场拍照</span>
                          <a class="upload-content">
                            ...
                            <i-button class="searchButton" type="primary" :size="small" style="display: inline-block;" @click="download(auditModel.headPortraitUrl)">查看</i-button>
                        ...
                        <i-col span="4">
                          ...
                          <a class="upload-content">
                            ...
                            <i-button class="searchButton" type="primary" :size="small" style="display: inline-block;" @click="download(auditModel.lawyerUrl)">查看</i-button>
                        ...
                        <i-col span="4">
                          ...
                          <a class="upload-content">
                            ...
                            <i-button class="searchButton" type="primary" :size="small" style="display: inline-block;" @click="download(auditModel.certificationUrl)">查看</i-button>
                          </a>
                        </i-col>
                        <i-col span="4" style="margin-right: 0">
                          ...
                          <a class="upload-content">
                            ...
                            <i-button class="searchButton" type="primary" :size="small" style="display: inline-block;" @click="download(auditModel.attorneyUrl)">查看</i-button>
                          </a>
                        </i-col>
                      </i-row>
                    </div>
                  ...
                  <i-row>
                    <i-col span="24">
                      <i-form-item class="raido-box" label="审核意见:" prop="approvalStatus">
                        <RadioGroup v-model="auditModel.approvalStatus" type="button" @on-change="changeApprovalStatus">
                          ...
                          <Radio label="2" style="width: 100px;" :class="{selectColor:!isApproval&&!isCancel}">
                            <span>不予会见</span>
                          </Radio>
                          <!-- <Radio label="3" style="width: 100px;" :class="{selectColor:isCancel}">
                            <span>逾期取消</span>
                          </Radio> -->
                        </RadioGroup>
                      </i-form-item>
                  ...
                  <i-row>
                    <i-col span="24">
                      <i-form-item label="备注说明:" prop="remarks" class="ipt-row" id="sfz">
                        <i-input v-model="auditModel.remarks" v-bind:disabled="!isAudit"></i-input>
                      </i-form-item>
                    </i-col>
                  </i-row>
                </i-form>
          ...
          <i-tab-pane label="审核通过" name="audit" style="position:relative;">
            <div class="searchTitleInput">
              ...
              <span class="searchItemText">身份证号:</span>
              <input class="searchItemInput" type="text" v-model="searchCon1.data.prisonerIdCard" placeholder="请输入在押人员身份证号">
              <span class="searchItemText">档案编号:</span>
              ...
              <span class="searchItemText">律师身份证号:</span>
              <input class="searchItemInput" type="text" v-model="searchCon1.data.idCard" placeholder="请输入律师身份证号">
              <span class="searchItemText">预约时间:</span>
              ...
              <i-button ghost style="margin-left: 25px;" @click="searchByCon1" class="searchButton">查询</i-button>
            </div>
            ...
            <i-modal v-model="uploadCustomTempModel" width="55%" height="80%">
              <p slot="header">
                <span class="title">上传笔录模板</span>
              </p>
              <div style="width:100%">
                <i-upload action="" style="margin-left: 80%" type="select" :before-upload="uploadCustomTemp" :format="['doc', 'docx', 'DOC', 'DOCX']" accept=".doc,.docx,.DOC,.DOCX">
                  <NormalButton type="primary" label="新增" size="small" class="searchButton"></NormalButton>
                </i-upload>
              </div>
              <i-table border ref="table" :columns="customTempColumns" :data="customTempData" style="height:calc(100% - 12vw);margin:0 10px;">
...
import {
  ...
  submitAuditModel, uploadImage, updateRoomStatus, searchRybhName, searchBoxDataUrl, getRoomStatus, getLawyerInfo, uploadTranscriptTemplate, searchCustomTemp, deleteTranscriptTemplate, updateTranscriptTemplate
            ...
            return h('div', [
              h('Upload', {
                props: {
                  ...
                  'before-upload': this.uploadCustomTemp
                },
                style: {
                  display: 'inline',
                  marginLeft: '35%',
              ...
              h(NormalButton, {
                ...
                on: {
                  click: () => {
                    this.deleteCustomTemp(params.row.id);
                  }
                }
              })
            ]);
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.meetStatus) {
              if (params.row.meetStatus === '0' && params.row.approvalStatus !== 2) {
                return h('span', {
                  style: {
                    color: '#007afe'
                  }
          ...
          render: (h, params) => {
            if (params.row.approvalStatus === '1') {
              return h('span', {
                ...
                on: {
                  click: () => {
                    this.openUploadModel(params.row.id);
                  }
                }
              }, '查看');
            }
  ...
  methods: {
    ...
    commitAuditModel1 () {
      this.$refs['auditModel1'].validate((valid) => {
        if (valid) {
          /*          validateLawyerRule(this.auditModel1).then(res => {
            if (res.data.state.code === 200) { */
    ...
    searchCustomTemp () {
      searchCustomTemp(this.customTempId).then(res => {
        this.customTempData = res.data.data;
      });
    },
    uploadCustomTemp (file) {
      const formData = new window.FormData();
      formData.append('file', file);
      formData.append('id', this.customTempId);
      if (this.fileId) { // 有fileId的情况是修改 没有则新增
        formData.append('fileId', this.fileId);
        updateTranscriptTemplate(formData).then(res => {
          if (res.data.state.code === 200) {
            this.$Message.success('修改成功');
            this.searchCustomTemp();
          } else {
            // 上传失败后台已经给出提示
    ...
    deleteCustomTemp (fileId) {
      deleteTranscriptTemplate(this.customTempId, fileId).then(res => {
        if (res.data.state.code === 200) {
    ...
    closeUploadModal () {
      this.customTempId = '';
      this.uploadCustomTempModel = false;
    },
    openUploadModel (id) {
      this.customTempId = id;
      this.uploadCustomTempModel = true;
      this.searchCustomTemp();
    }
  },
  watch: {
