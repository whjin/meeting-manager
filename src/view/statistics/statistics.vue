  ...
  <i-content class="main-content-con">
    ...
    <div class="statistics">
      ...
      <div class="content">
        <div class="item">
          <!--会见统计-->
          <span class="statisticsETitle">会见情况统计</span>
          <div class="pieBorder"></div>
          <div ref="meetStatistics" class="meetStatistics" style="height: 100%"></div>
        </div>
        <div class="item">
          <span class="statisticsETitle">律师房间使用情况</span>
          <div style="position:absolute;right: 26px;z-index: 1;top: 9px;">
            <span class="searchItemText">时间:</span>
...
import { getAppointTrendData, getMeetStatisticsData, getAppointmentStatistics, getLawyerRoomDetail } from '@/api/bg-manage/statistics/statistics';
import { formatDateToStr } from '@/libs/tools';
export default {
  name: 'statistics',
  data () {
    return {
      colorList: ['#027CFF', '#F9523E', '#3af9f6'],
  ...
  methods: {
    ...
    initMeetStatistics () {
      ...
      getMeetStatisticsData().then(res => {
    ...
    initLawyerRoomDetail () {
      ...
      getLawyerRoomDetail(queryData).then(res => {
      ...
      //   date: formatDateToStr(this.orderTime)
      // };
      // getLawyerRoomDetail(data).then(res => {
      //   let option = {
      //     color: this.colorList,
      //     tooltip: {
      //       trigger: 'item',
      ...
      //         },
      //         type: 'category',
      //         data: ['09:00-10:00', '10:00-11:00', '11:00-12:00', '14:00-15:00', '15:00-16:00', '16:00-17:00'],
      //         axisPointer: {
      //           type: 'shadow'
      //         },
      //         axisLine: {
...
<style lang="less" scoped>
  .statisticsTitle{
    ...
    font:bold 30px/74px Microsoft YaHei;
    padding-left:40px;
